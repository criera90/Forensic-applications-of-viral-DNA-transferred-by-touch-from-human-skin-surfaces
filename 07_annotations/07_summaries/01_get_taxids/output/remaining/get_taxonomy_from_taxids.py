...
def command_line_interaction():
    ...
    return([dataset,contigs_list,tax_db_dir,output_dir])
...
for contig in contigs:
    df_temp=df.query('qaccver == @contig & evalue < 1e-40 & qcovs >= 70 & sskingdoms.notna()').sort_values(by=["qcovs"],ascending = False)
