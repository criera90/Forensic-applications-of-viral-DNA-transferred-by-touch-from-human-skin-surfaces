...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --mem=800GB       # Maximum memory (in Gb)
#SBATCH --cpus-per-task=40
#SBATCH --job-name=more_TO_pooled_samples
...
INPUT_DIR="PATH_TO_YOUR_WORKING_DIR/NIJ2_TO_2/01_assemblies/input/TO_samples"
