...
#SBATCH --job-name=TO_index_mapping_contigs
#SBATCH --error=PATH_TO_YOUR_WORKING_DIR/03_mapping_reads_back_to_contigs/SLURM_reports/job.%A.%a.%x.err
#SBATCH --output=PATH_TO_YOUR_WORKING_DIR/03_mapping_reads_back_to_contigs/SLURM_reports/job.%A.%a.%x.out
### counter start ###
STARTTIME=$(date +%s)
###############################################################################
